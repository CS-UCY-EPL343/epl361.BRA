...
public class ChefLoginTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void chefLoginTest() {
        ...
        ViewInteraction editText2 = onView(
                allOf(withId(R.id.txtUser),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        editText2.perform(replaceText("cook1"), closeSoftKeyboard());
        ...
        ViewInteraction editText3 = onView(
                allOf(withId(R.id.txtPass),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        editText3.perform(replaceText("cook"), closeSoftKeyboard());
